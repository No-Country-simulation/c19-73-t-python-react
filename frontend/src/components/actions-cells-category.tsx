...
const ActionsCellsCategory: React.FC<ActionsCellProps> = ({ categoria }) => {
  const [selectedCategoria, setSelectedCategoria] = useState<categorias_productos | null>(null);
  ...
  const handleSave = async () => {
    if (selectedCategoria) {
      ...
      toast.success("Categoría modificada", {
        description: "El nombre de la categoría seleccionada ha sido modificado con éxito",
      });
          ...
          <DialogContent className="sm:max-w-md">
            ...
            <div className="grid gap-4 py-4">
              <div className="grid grid-cols-4 items-center gap-4">
                <Label htmlFor="nombreActual" className="col-span-1 text-right text-sm">
                  Nombre actual:
                </Label>
              ...
              <div className="grid grid-cols-4 items-center gap-4">
                <Label htmlFor="nuevoNombre" className="col-span-1 text-right text-sm">
                  Nuevo nombre:
                </Label>
                <input
                  type="text"
